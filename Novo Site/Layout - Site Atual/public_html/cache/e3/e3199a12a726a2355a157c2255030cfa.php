...
/* forgot.html */
class __TwigTemplate_5832b9b8a8582c306e638d0d19ca7f31 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("login.html", "forgot.html", 1);
...
";
    ...
    {
        return new Source("", "forgot.html", "/home/heron/Desktop/programming/servicos/Savior---novo-layout/Novo Site/Layout - Site Atual/public_html/view/forgot.html");
    }
}
