...
/* login.html */
class __TwigTemplate_5371e2d61d771e60cbb3e69b2133bc8c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<span class=\"tab-button active\" data-tab=\"news\">Last News</span>
\t\t\t\t\t\t\t<p class=\"pp\">/</p>
\t\t\t\t\t\t\t<span class=\"tab-button\" data-tab=\"events\">events</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"news-top-text tab-block active\" id=\"news\">
\t\t\t\t\t\t\t<div class=\"news flex-s-c\">
\t\t\t\t\t\t\t\t<a href=\"\"><span class=\"news-1\">[NEWS] </span> The battles and battles of world history
\t\t\t\t\t\t\t\t\thave always world history have always.</a>
...
\t\t\t\t\t\t\t<div class=\"news flex-s-c\">
\t\t\t\t\t\t\t\t<a href=\"\"><span class=\"news-1\">[NEWS] </span> The battles and battles of world history
\t\t\t\t\t\t\t\t\thave always world history have alwayshave always world history have always.</a>
\t\t\t\t\t\t\t\t<span class=\"date\">15/09/2019</span>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"news flex-s-c\">
\t\t\t\t\t\t\t\t<a href=\"\"><span class=\"news-1\">[NEWS] </span> The battles and battles of world history
...
";
    ...
    {
        return new Source("", "login.html", "/home/heron/Desktop/programming/servicos/Savior---novo-layout/Novo Site/Layout - Site Atual/public_html/view/login.html");
    }
}
