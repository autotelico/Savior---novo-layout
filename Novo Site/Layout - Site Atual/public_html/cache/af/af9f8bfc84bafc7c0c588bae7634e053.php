...
/* order-details.html */
class __TwigTemplate_1c308a82404e845f7cdcd8bace15e1af extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"home-content\">
        ...
        if (((twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "status", [], "any", false, false, false, 46) == "Pendente") || (twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "status", [], "any", false, false, false, 46) == "Em Processamento"))) {
            ...
            // line 62
            echo "                                   ";
            if ((twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "PaymentMethod", [], "any", false, false, false, 62) == "PAYPAL")) {
                // line 63
...
";
    ...
    {
        return new Source("", "order-details.html", "/home/u920559473/domains/metin2savior.com/public_html/view/order-details.html");
    }
}
