...
/* ranking-guild.html */
class __TwigTemplate_5e11838392d87bd59c87ea09dd92bc3a extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("structure.html", "ranking-guild.html", 1);
...
";
    ...
    {
        return new Source("", "ranking-guild.html", "/home/u811429539/domains/mt2.pro/public_html/xtremepvp/view/ranking-guild.html");
    }
}
