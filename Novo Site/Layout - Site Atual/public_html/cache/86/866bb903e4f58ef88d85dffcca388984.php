...
/* structure.html */
class __TwigTemplate_6026832fb3142fc0afef166a6a9d5a8b extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    ";
        ...
        <div class=\"copyright\">
            <p class=\"m-0 p-1 text-light text-center\">Qualquer ato realizado utilizando algo relacionado ao Chaos2 é de responsabilidade exclusiva do usuário.</p>
            <p class=\"m-0 p-1 text-light text-center\">Chaos2 é uma organização independente sem fins lucrativos. As marcas registradas são seus devidos proprietários!</p>
        </div>
    </footer>
    ...
    {
        return new Source("", "structure.html", "/home/u811429539/domains/mt2.pro/public_html/chaos2/view/structure.html");
    }
}
