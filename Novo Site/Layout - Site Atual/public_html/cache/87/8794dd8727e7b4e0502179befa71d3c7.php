...
/* downloads.html */
class __TwigTemplate_ccbcb8c357bbfc7db787ca0d38c19176 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("structure-no-logo.html", "downloads.html", 1);
...
\t\t\t\t\t\t\t\t\t\t\ttitle=\"nickname\">KINGman</a></span>
\t\t\t\t\t\t\t\t\t<span class=\"top-lvl\">150</span> <span class=\"top-Res\">400<sup>398</sup></span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t<li class=\"top-list\">
\t\t\t\t\t\t\t\t\t<span class=\"top-number\">2.</span> <span class=\"top-flag\"><img
\t\t\t\t\t\t\t\t\t\t\tsrc=\"images/flag-icon.png\" alt=\"\"></span> <span class=\"top-name\"><a href=\"\"
\t\t\t\t\t\t\t\t\t\t\ttitle=\"nickname\">TOR_GOR</a></span>
\t\t\t\t\t\t\t\t\t<span class=\"top-lvl\">150</span> <span class=\"top-Res\">400<sup>398</sup></span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t<li class=\"top-list\">
...
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<span class=\"page-title-content\">This section contains all the necessary files to start playing
\t\t\t\t\t\t\tMuOnline
\t\t\t\t\t\t\ton our server</span>
\t\t\t\t\t\t<div class=\"dBlock\">
...
";
    ...
    {
        return new Source("", "downloads.html", "/home/heron/Desktop/programming/servicos/Savior---novo-layout/Novo Site/Layout - Site Atual/public_html/view/downloads.html");
    }
}
